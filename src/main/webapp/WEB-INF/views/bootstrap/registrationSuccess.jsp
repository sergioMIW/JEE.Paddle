		...
		<div class="container">
                        <div class="content-link col-md-12">
                            <div id="contact_form" class="top-score-title col-md-9 align-center">
                                <h3 class="news-title n-match">
                        <span> La  ha sido creado satisfactoriamente</span><span class="point-little">.</span>
                    </h3>
                    <p class="subtitle">
                         <a href="<c:url value='/court-list' />">Ir a Lista de Pistas</a>
                    </p>
